 ...
 * element interface generated in the com.kkcom.mypib.login.svc.ws.client.stub
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Authenticate_QNAME = new QName(
			"http://ws.svc.login.mypib.kkcom.com/", "authenticate");
	private final static QName _AuthenticateResponse_QNAME = new QName(
			"http://ws.svc.login.mypib.kkcom.com/", "authenticateResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package:
	 * com.kkcom.mypib.login.svc.ws.client.stub
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://ws.svc.login.mypib.kkcom.com/", name = "authenticate")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://ws.svc.login.mypib.kkcom.com/", name = "authenticateResponse")
